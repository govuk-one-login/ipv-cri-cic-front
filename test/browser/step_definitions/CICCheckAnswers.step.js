...
Then(
  /^the Confirm your details warning message appears$/,
  { timeout: 2 * 50000 },
  async function () {
    const cpdPage = new CheckDetailsPage(await this.page);
    expect(await cpdPage.checkWarning()).toContain(
      "You cannot change your 2 and date of birth once you continue to the next page.",
    );
  },
);
