...
then
    ...
    export ECR_BASE_IMAGE="060113405249.dkr.ecr.eu-west-2.amazonaws.com/cic-cri-front-ecr-containerrepository-ymfhj103wnlw:de58a087b557fa09fd77c95024bb7481f91e3505:latest"
    export SAM_STACK=$1 
